...
from metricheq.connectors.base import TokenAuthenticator

from metricheq.connectors.pager_duty import (
    PagerDutyClient,
    PagerDutyConfig,
    PagerDutyConnector,
)
...
class TestPagerDutyConnector(unittest.TestCase):
    ...
    @patch("metricheq.connectors.pager_duty.PagerDutyClient")
